...
public class Principal extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cuenta) {
            ...
            Intent intent = new Intent(Principal.this,Internet.class);
            startActivity(intent);

        } else if (id == R.id.nav_duos) {
            Intent intent = new Intent(Principal.this,duo.class);
            startActivity(intent);

        } else if (id == R.id.nav_Atencion) {
            Intent intent = new Intent(Principal.this,Atencion.class);
            startActivity(intent);
        }
